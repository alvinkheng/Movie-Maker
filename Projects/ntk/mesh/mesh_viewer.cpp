...
namespace ntk
{
    ...
    void MeshViewer :: initializeCameraView()
    {
        makeCurrent();
        viewMatrix matrix;
        glMatrixMode(GL_MODELVIEW);
    ...
    // Added by Tatiana Iskandar; Sets the camera at cameraIndex's view matrix
    void MeshViewer :: saveCameraView(int cameraIndex)
    {
        viewMatrix matrix;
        makeCurrent();
        glMatrixMode(GL_MODELVIEW);
    ...
    void MeshViewer :: setCameraView(int cameraIndex)
    {
        makeCurrent();
        glMatrixMode(GL_MODELVIEW);
        glLoadIdentity();
    ...
    // Added by Tatiana Iskandar; adds new camera with current view
    void MeshViewer :: newCameraView()
    {
        viewMatrix matrix;
        makeCurrent();
        glMatrixMode(GL_MODELVIEW);
