...
**
** Created: Mon May 28 16:42:21 2012
...
public:
    ...
    void setupUi(QMainWindow *View3DWindow)
    {
        ...
        horizontalLayout0 = new QHBoxLayout(frame0);
